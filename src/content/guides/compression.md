...
| Deflate | `deflate` | RFC 1950 | The `deflate` content-encoding is the zlib format (RFC 1950), which wraps the DEFLATE algorithm (RFC 1951) also used internally by gzip. Less common as a direct content encoding. |
